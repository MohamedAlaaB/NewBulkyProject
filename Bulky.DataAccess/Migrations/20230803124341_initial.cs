    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "portsaid", "ptsMain", 1000000, 0, "Portsaid", "xxx" },
                    { 2, "Elgiza", "CairosMain", 1200000, 1000, "Cairo", "xxx" },
                    { 3, "Elshorouk", "mool", 12030000, 2000, "Cairo", "xxx" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Author", "CategoryId", "Description", "ISBN", "ImageUrl", "ListPrice", "Price", "Price100", "Price50", "Title", "test" },
                values: new object[,]
                {
